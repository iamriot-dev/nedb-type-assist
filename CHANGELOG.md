...
- Fixed types on `sort()` to no longer require all fields to be present.
- Allow `null` and concrete values in search queries.
- Allow `null` in `$ne` operator.

## [0.4.1] - 2026-05-15

### Fixed

- Improved detection between include and exclude projections.
- Improved type accuracy of `withoutId()`.
